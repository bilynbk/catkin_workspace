...
(cl:in-package flexrobot_description_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <demo_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demo_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name flexrobot_description_pkg-msg:<demo_msg> is deprecated: use flexrobot_description_pkg-msg:demo_msg instead.")))

(cl:ensure-generic-function 'greeting-val :lambda-list '(m))
(cl:defmethod greeting-val ((m <demo_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flexrobot_description_pkg-msg:greeting-val is deprecated.  Use flexrobot_description_pkg-msg:greeting instead.")
  (greeting m))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <demo_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flexrobot_description_pkg-msg:number-val is deprecated.  Use flexrobot_description_pkg-msg:number instead.")
  (number m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<demo_msg>)))
  ...
  "flexrobot_description_pkg/demo_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'demo_msg)))
  "Returns string type for a message object of type 'demo_msg"
  "flexrobot_description_pkg/demo_msg")
