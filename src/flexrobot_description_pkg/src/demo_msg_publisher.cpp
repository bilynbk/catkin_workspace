...
#include "flexrobot_description_pkg/demo_msg.h"
#include <iostream>
#include <sstream>
...

{
	...
	ros::Publisher number_publisher = node_obj.advertise<flexrobot_description_pkg::demo_msg>("/demo_msg_topic",10);
	...
	while (ros::ok())
	{
		...
		flexrobot_description_pkg::demo_msg msg;
