...
(cl:in-package flexrobot_description_pkg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <demo_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demo_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name flexrobot_description_pkg-srv:<demo_srv-request> is deprecated: use flexrobot_description_pkg-srv:demo_srv-request instead.")))

(cl:ensure-generic-function 'in-val :lambda-list '(m))
(cl:defmethod in-val ((m <demo_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flexrobot_description_pkg-srv:in-val is deprecated.  Use flexrobot_description_pkg-srv:in instead.")
  (in m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<demo_srv-request>)))
  ...
  "flexrobot_description_pkg/demo_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'demo_srv-request)))
  "Returns string type for a service object of type 'demo_srv-request"
  "flexrobot_description_pkg/demo_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <demo_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demo_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name flexrobot_description_pkg-srv:<demo_srv-response> is deprecated: use flexrobot_description_pkg-srv:demo_srv-response instead.")))

(cl:ensure-generic-function 'out-val :lambda-list '(m))
(cl:defmethod out-val ((m <demo_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flexrobot_description_pkg-srv:out-val is deprecated.  Use flexrobot_description_pkg-srv:out instead.")
  (out m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<demo_srv-response>)))
  ...
  "flexrobot_description_pkg/demo_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'demo_srv-response)))
  "Returns string type for a service object of type 'demo_srv-response"
  "flexrobot_description_pkg/demo_srvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'demo_srv)))
  ...
  "flexrobot_description_pkg/demo_srv")